              ...
              <ul className="inline-flex gap-1">
                <li className="flex items-center">
                  <a
                    ...
                    href="https://discord.gg/QtZAvCn7UT"
                    target="_blank"
                    aria-label="Discord"
                  >
                    <svg className="h-6 w-8 fill-current" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                      <g>
                ...
                <li className="flex items-center">
                  <a
                    ...
                    aria-label="Twitter"
                  >
                    <svg className="h-6 w-8 fill-current" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24">
